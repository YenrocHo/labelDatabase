...
import com.fc.aden.model.custom.ColumnEntity;
import com.fc.aden.model.custom.TableEntity;
import com.fc.aden.model.custom.TsysTables;
...
*/
    ...
    public static void generatorCode(TsysTables table, List<Map<String, String>> columns, ZipOutputStream zip) {
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.fc.aden" : mainPath;
        //封装模板数据
